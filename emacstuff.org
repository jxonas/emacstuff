...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-<f7>") (lambda () (interactive) (jx--deft "md" "gpg" 'markdown-mode)))
#+end_src
* Racket mode
#+begin_src emacs-lisp
  (require 'racket-mode)
...
* Sandbox and Scratch
#+begin_src emacs-lisp
  (defun jx--sandbox-general (ext)
    (interactive "sExtension: ")
    (find-file (jx--sandbox-file (concat "sandbox." ext))))

  (defun jx--sandbox-racket ()
    (interactive)
    (jx--sandbox-general "rkt"))
